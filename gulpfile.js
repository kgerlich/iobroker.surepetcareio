...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new surepetcareio name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/surepetcareio.png')) {
        fs.renameSync(__dirname + '/admin/surepetcareio.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/surepetcareio.html')) {
        fs.renameSync(__dirname + '/widgets/surepetcareio.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/surepetcareio/js/surepetcareio.js')) {
        fs.renameSync(__dirname + '/widgets/surepetcareio/js/surepetcareio.js', __dirname + '/widgets/surepetcareio/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/surepetcareio')) {
        fs.renameSync(__dirname + '/widgets/surepetcareio',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /surepetcareio/g,
            replacement: newname
        },
        {
            match: /surepetcareio/g,
        ...
        {
            match: /surepetcareio/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'surepetcareio'
        },
        {
